...
if __name__ == '__main__':
    ...
    model = resnet_model(64, 64, 4, 2)
    early_stop = EarlyStopping(monitor='val_acc', verbose=1, patience=10, mode='max')
    save_best = ModelCheckpoint('resnet_best_model.hdf5', verbose=1, save_best_only=True)
    ...
    np.savetxt('resnet.txt', (fpr, tpr))
    a = np.loadtxt('resnet.txt')
