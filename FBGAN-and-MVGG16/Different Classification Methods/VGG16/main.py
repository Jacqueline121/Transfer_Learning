...
if __name__ == '__main__':
    ...
    model = vgg_model(64, 64, 4, 2)
    early_stop = EarlyStopping(monitor='val_acc', verbose=1, patience=10, mode='max')
    save_best = ModelCheckpoint('vgg_best_model.hdf5', verbose=1, save_best_only=True)
    ...
    np.savetxt('vgg16.txt', (fpr, tpr))
    a = np.loadtxt('vgg16.txt')
